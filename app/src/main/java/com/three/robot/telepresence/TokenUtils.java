...
public final class TokenUtils {
     ...
     */
    public static void gen(String channelName, int uid, String APP_ID,String APP_CERT,OnTokenGenCallback<String> onGetToken) {
        gen(APP_ID, APP_CERT, channelName, uid, ret -> {
            if (onGetToken != null) {
                runOnUiThread(() -> {
